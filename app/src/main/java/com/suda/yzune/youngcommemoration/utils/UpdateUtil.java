...
import com.suda.yzune.youngcommemoration.bean.UpdateInfo;
...
public class UpdateUtil {
    ...
    public static void checkUpdate(final Context context, final int signal) {
        OkHttpUtil.getAsync("http://106.15.202.52:8080/school/getupdate_mie", new OkHttpUtil.ResultCallback() {
            @Override
    ...
    public static void showAlert(final Context context, String version, String info) {
        ...
        builder.setPositiveButton("去看看", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                Uri content_url = Uri.parse("https://www.coolapk.com/apk/com.suda.yzune.youngcommemoration");
